...
| ------------------------------------- | ------------------------------------------------------------ | --------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 4E01<br />工程师视角下的AI/GenAI      | 1. AI简要历史、技术范围<br />2. 多角度理解GenAI/LLM：任务/数据/CS<br />3. LLM能力边界<br />4. LLM全生命周期技术简介<br />5. LLM融入日常工作<br />6. LLM应用方法论与团队角色 | /                                 | [4E01(PDF)](https://github.com/LloydS827/WhysAI-LLMFS-4E/blob/main/articles/240823_4E01_Intro_2_AI%26GenAI.pdf) | 1. **Highly Recommanded**: Karpathy's Lecture on [ Intro to Large Language Models - YouTube](https://www.youtube.com/watch?v=zjkBMFhNj_g&t=2882s)<br />2. **Our CB-series**: [LloydS827/WhysAI-LLMFS-CB (github.com)](https://github.com/LloydS827/WhysAI-LLMFS-CB)<br />3. **GenAI Course by Andrew**: [Generative AI for Everyone - DeepLearning.AI](https://www.deeplearning.ai/courses/generative-ai-for-everyone/)<br />4. Sum of all short courses on deeplearnin.ai, cutoff-Aug.15.2024: [deeplearning.ai -- Short Courses](https://github.com/LloydS827/WhysAI-LLMFS-4E/blob/main/deeplearning.ai-ShortCourses.md)<br />5. First DL end2end prject introduced by Andrej Karpathy: [Deep Neural Nets: 33 years ago and 33 years from now (karpathy.github.io)](https://karpathy.github.io/2022/03/14/lecun1989/)<br />6. The Bitter Lesson by Rich Sutton |
| 4E02-1<br />实用Prompt Engineeing技巧 | 通过实际案例，掌握PE基本结构与方法论，进而试验PE实用技巧与最佳实践。同时介绍如COT/DSPY等前沿方法。 | P1: Prompt Engineering            | [4E02-1(PDF)](https://github.com/LloydS827/WhysAI-LLMFS-4E/blob/main/articles/240911_4E02-1_Everything_about_PE.pdf) | 1. **Highly Recommanded**: [ChatGPT Prompt Engineering for Developers - DeepLearning.AI](https://www.deeplearning.ai/short-courses/chatgpt-prompt-engineering-for-developers/)<br>2. PE Framework：[AUTOMAT & CO-STAR Framework](https://medium.com/the-generator/the-perfect-prompt-prompt-engineering-cheat-sheet-d0b9c62a2bba)<br>3. PE vs Web Design: [Prompt design](https://www.cursor.com/blog/prompt-design#priompt-v01-a-first-attempt-at-a-prompt-design-library)<br>4. Advices for GPT's Configuration: [Cheat Sheet: Mastering Temperature and Top_p in ChatGPT](https://community.openai.com/t/cheat-sheet-mastering-temperature-and-top-p-in-chatgpt-api/172683)<br>5. Nature Essay on PE: [Chatbots in science](https://www.nature.com/articles/d41586-024-02630-z)<br>6. More PE Techniques: [Prompt Engineering Guide](https://www.promptingguide.ai/)<br>7. PE for Vision: [Prompt Engineering for Vision Models - DeepLearning.AI](https://www.deeplearning.ai/short-courses/prompt-engineering-for-vision-models/)<br>8. COT paper: [[Chain-of-Thought Prompting Elicits Reasoning in Large Language Models](https://arxiv.org/abs/2201.11903)<br>9. SAM Official Demo:[Segment Anything \| Meta AI (segment-anything.com)](https://segment-anything.com/demo)<br>10. WnB Weave: [W&B Weave (wandb.ai)](https://wandb.ai/site/weave/) |
...
| 4E02-3<br />检索增强RAG项目           | 1. RAG项目整体Pipeline<br />2. 建立知识库：文档解析、Embedding模型与向量数据库接入<br />3. 使用langchain实现RAG问答流程<br />4. 使用Streamlit创建RAG应用 | P3: 私有知识问答的检索增强RAG项目 |                                                              | [15 Advanced RAG Techniques \| WillowTree (willowtreeapps.com)](https://www.willowtreeapps.com/guides/advanced-rag-techniques)<br>Rag From Stratch by langchain: [https://github.com/langchain-ai/rag-from-scratch](https://github.com/langchain-ai/rag-from-scratch) |
...
| 4E03 Series<br />RAG In Depth<br />   | 基于4E02-3内容，深入理解RAG技术与实践，包括Agentic RAG、知识图谱+RAG、RAG架构Llamaindex等 |                                   |                                                              | https://mp.weixin.qq.com/s/KKDZmkyUzu1bP1M-9zds-A            |
| 4E04 Series<br />Agent In Depth       | 基于4E02-4内容，深入理解Agent技术与实践，包括MAS架构CrewAI、langgraph、Autogen等 |                                   |                                                              | https://mp.weixin.qq.com/s/CVmqZvePPMQgTs3JULyEZQ<br>langchain academy: [Introduction to LangGraph (langchain.com)](https://academy.langchain.com/courses/intro-to-langgraph) |
| 4E05 Series<br />前沿技术赏析         | LLM-based Agent前沿成果展示，例如AutoGPT、ChatDev、Agent Q等项目<br />具身智能机器人前沿成果展示，例如Aloha、RT-H、无人机等 |                                   |                                                              |                                                              |
|                                       | Cursor AI Tutorial                                           |                                   |                                                              | [How I code 159% Faster using AI (Cursor + Sonnet 3.5) (youtube.com)](https://www.youtube.com/watch?v=yk9lXobJ95E) |
...
- [deeplearning.ai -- sum of all Short Courses(Aug.15.2024)](https://github.com/LloydS827/WhysAI-LLMFS-4E/blob/main/deeplearning.ai-ShortCourses.md)

**Important：**
- langchain academy: [Introduction to LangGraph (langchain.com)](https://academy.langchain.com/courses/intro-to-langgraph)
